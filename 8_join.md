...
#### [Задача 8](https://lab.karpov.courses/learning/152/module/1762/lesson/17929/53217/260453)
...
<img width="477" height="414" alt="image" src="https://github.com/user-attachments/assets/dfd9cac3-6283-4c53-a0bf-6d4baf0b221d" />

`На заметку:`

Подробнее с `CROSS JOIN` можно ознакомиться [здесь](https://neon.com/postgresql/postgresql-tutorial/postgresql-cross-join).
...
SELECT user_id, 
name
FROM (SELECT user_id FROM users LIMIT 100) AS u
CROSS JOIN 
...
#### [Задача 9](https://lab.karpov.courses/learning/152/module/1762/lesson/17929/53217/257157)
...
#### [Задача 10](https://lab.karpov.courses/learning/152/module/1762/lesson/17929/53217/257174)
...
JOIN orders AS o
ON ua.order_id = o.order_id
WHERE ua.order_id NOT IN (SELECT * FROM subq_1)
ORDER BY user_id ASC, order_id ASC
LIMIT 1000

```

#### [Задача 11](https://lab.karpov.courses/learning/152/module/1762/lesson/17929/53217/257175)
